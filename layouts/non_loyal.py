...
per_services_satisfaction_eco_fig = per_services_satisfaction_bar_chart(read_csv(f'{local_path}services_satisfaction_disloyal_eco.csv'), "eco")
per_services_satisfaction_business_fig = per_services_satisfaction_bar_chart(read_csv(f'{local_path}services_satisfaction_disloyal_business.csv'), "business")
flight_distance_eco_fig = flight_distance_histogram(read_csv(f'{local_path}flight_distribution_disloyal_eco.csv'), "eco")
flight_distance_business_fig = flight_distance_histogram(read_csv(f'{local_path}flight_distribution_disloyal_business.csv'), "business")
flight_distance_satisfaction_fig = flight_distance_satisfaction_histogram(read_csv(f'{local_path}satisfaction_per_distance_disloyal.csv'), False)
